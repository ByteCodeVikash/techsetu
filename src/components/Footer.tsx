...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-950 text-slate-300 py-16 text-xs border-t border-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-12 border-b border-slate-900">
          ...
          <div className="space-y-3 lg:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="text-base font-bold text-white leading-none">TechSetu</span>
                <span className="text-[10px] text-slate-400 font-medium tracking-wide mt-0.5">Bridge to Future Skills</span>
              </div>
            </div>

            <p className="text-xs text-slate-400 leading-relaxed pt-1">
              Practical learning and technology solutions for individuals and businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400">
              <li><Link to="/courses" className="hover:text-white transition-colors">Courses Catalog</Link></li>
              <li><Link to="/courses?category=live" className="hover:text-white transition-colors">Live Classes</Link></li>
              ...
              <li><Link to="/courses" className="hover:text-white transition-colors">Career Paths</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-400">
              <li><Link to="/services/it" className="hover:text-white transition-colors">IT Services</Link></li>
              <li><Link to="/services/digital-marketing" className="hover:text-white transition-colors">Digital Marketing</Link></li>
              <li><Link to="/services/ai" className="hover:text-white transition-colors">AI Services</Link></li>
              <li><Link to="/services" className="hover:text-white transition-colors">Corporate Training</Link></li>
            </ul>
          </div>
